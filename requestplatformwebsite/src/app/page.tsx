    ...
    <>
      ...
      <section id="home" style={{ padding: "24px 0" }}>
        <div className="container">
          <h1>Welcome</h1>
          <p>
            Use the Tasks tab to view and manage tasks. Filter by status,
            subteam, or use the search box to find tasks across all columns
            (Uncompleted–Unassigned, Uncompleted–Assigned, Completed).
          </p>
        </div>
      </section>
      ...
      <section id="tasks" style={{ padding: "24px 0" }}>
        <div className="container">
          ...
          <TaskBoard
            ...
            onToggle={(id: string) => {
              const t =
                filteredTasks.find((x) => x.id === id) ??
                /* fall back to full set if filtered out */ tasks.find(
                  (x) => x.id === id
                );

              if (!t) {
                console.error(
                  `Task with id "${id}" not found when toggling completion.`
                );
              }
      ...
      <section id="help" style={{ padding: "24px 0" }}>
        <div className="container">
          ...
          <div>
            <ol>
              <li>
                Click <em>Add Task</em> in the navbar to create a task.
              </li>
              <li>
                Use <strong>Status</strong>, <strong>Subteam</strong>, and{" "}
                <strong>Search</strong> to narrow tasks.
              </li>
              <li>
